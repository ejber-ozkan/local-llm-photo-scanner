...
def test_search_filters(client, mock_db_file):
    ...
    c = conn.cursor()
    c.execute("INSERT INTO photos (id, filepath, filename, description, status, date_taken, date_modified, ai_model, camera_make, camera_model) VALUES (1, '/p/1.jpg', 'photo1.jpg', 'dog jumping', 'processed', '2024-05-01', '2024-05-01', 'm1', 'Nikon', 'D850')")
    c.execute("INSERT INTO photos (id, filepath, filename, description, status, date_taken, date_modified, ai_model) VALUES (2, '/p/2.jpg', 'photo2.jpg', 'cat', 'processed', '2025-05-01', '2025-05-01', 'm1')")
