# Graph Report - LocalAIPhotoMetadataApplication  (2026-07-12)

## Corpus Check
- 57 files · ~48,140 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 607 nodes · 936 edges · 61 communities (37 shown, 24 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d55818fe`
...
Cohesion: 0.12
Nodes (20): Any, Synchronously upload and instantly process a single image bypassing the queue., scan_single(), _convert_gps_to_decimal(), _convert_heic_to_jpeg_bytes(), encode_image_to_base64(), extract_all_exif(), extract_exif_for_filters() (+12 more)
...
Cohesion: 0.05
Nodes (42): [3.0.0] - 2026-05-25, [3.10.0] - 2026-07-12, [3.1.0] - 2026-05-28, [3.2.0] - 2026-06-06, [3.3.0] - 2026-06-06, [3.3.1] - 2026-06-06, [3.4.0] - 2026-06-07, [3.5.0] - 2026-06-07 (+34 more)
...
Cohesion: 0.16
Nodes (8): formatScanCount(), GlobalScanStatusPanel(), ScanPanelItem, ConfirmModal, ScanLog, ScanMode, FolderScanStatus, ScanStatus

### Community 20 - "Community 20"
Cohesion: 0.14
Nodes (17): Any, Connection, control_folder_scan(), FolderScanControlRequest, Payload to pause, resume, or cancel the folder scanner., Pauses, resumes, or cancels/stops the active background directory scan., create_scan_session(), get_resumable_session() (+9 more)
...
Cohesion: 0.31
Nodes (9): Identify(), Identify, DuplicatePhoto, DuplicateReportGroup, Entity, PhotoEntity, TestResult, UniquePhoto (+1 more)
...
Cohesion: 0.22
Nodes (9): get_connection(), init_db(), init_single_db(), Connection, Initialize both the main and test databases.      This function iterates throu, Initialize a single SQLite database with the required schema.      Creates the, Get a connection to the specified database.      Args:         use_test_db (b, Application startup hook triggering local database initialization. (+1 more)

### Community 26 - "Community 26"
Cohesion: 0.21
Nodes (15): BaseModel, DatabaseCleanRequest, DatabaseCleanRequest, Pydantic data transfer objects (DTOs) for the application's API endpoints., Payload to update application settings, such as active LLM models., Response payload containing database items conforming to the query., Payload describing an entity renaming operation., Payload to obliterate all existing table architectures and recreate them. (+7 more)

### Community 27 - "Community 27"
Cohesion: 0.15
Nodes (13): find_best_face_match(), Find the best matching face for a given embedding in the database.      Compar, clear_gallery_filters_cache(), Invalidate cached gallery filter metadata after photo/entity changes., _clear_gallery_filters_cache(), Invalidate gallery filter cache after scan-side data changes., Load an Ollama model before the first real image request., warm_ollama_model() (+5 more)
...
Cohesion: 0.67
Nodes (3): Exception, ImageServiceError, Base exception for errors originating from the image service module.

### Community 32 - "Error Handling Component Module"
Cohesion: 0.14
Nodes (9): DuplicatesPage(), LazyImageProps, DuplicatesPage, Gallery, ImageMapPage, ScanPage, ScanTest, SettingsPage (+1 more)

## Knowledge Gaps
- **110 isolated node(s):** `StreamingResponse`, `Request`, `Any`, `Any`, `Gallery` (+105 more)
